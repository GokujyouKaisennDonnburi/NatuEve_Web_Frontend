...
export function FormTextarea({
  ...
  return (
    <Textarea
      {...props}
      className={cn(
        // ui/textarea の field-sizing-content は中身に合わせて高さを詰めてしまい、
        // rows での初期表示行数が効かなくなるため fixed に戻す
        "field-sizing-fixed rounded-xl border-(--form-border) bg-white px-3 py-2.5 text-sm text-slate-900 shadow-none placeholder:text-slate-400",
